...
class BenchmarkStats < Minitest::Benchmark
  ...
  def bench_stats
    assert_performance_linear 0.99 do |n|
      Stats.new("../data_large.txt", n).call
    end
  end
end
...
describe "Stats" do
  describe "Benchmarks" do
    it "does it work less than 500 milliseconds for 100_000 lines" do
      time = Benchmark.measure {
        Stats.new("../data_large.txt", 100_000).call
      }
      assert 0.5 > time.real
    end
  end
